      ...
      <div className="grid gap-4">
        {item ? (
          <div className="flex items-start gap-3 rounded-[18px] bg-[var(--color-surface-strong)] px-4 py-3 shadow-[inset_0_0_0_1px_var(--color-outline)]">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] bg-[var(--color-danger-icon-bg)] text-[var(--color-danger-icon)]">
              <Trash2 size={18} />
            </div>
        ...
        {isFolder ? (
          <div className="flex items-start gap-2 rounded-[14px] bg-[var(--color-warn-soft)] px-3 py-2.5 text-xs text-[var(--color-warn-text)]">
